                                    ...
                                    <div
                                        ...
                                        <div class="order-1 logo-wrapper">
                                            <a class="logo nasa-logo-retina nasa-has-sticky-logo nasa-has-mobile-logo"
                                                ...
                                                title="<?php echo osc_page_title(); ?> - " rel="Home">
                                                ...
                                                <?php } else { ?>
                                                    <h3><a
                                                            href="<?php echo osc_base_url(); ?>"><?php echo osc_page_title(); ?></a>
                                                    </h3>
                                            ...
                                            <div class="nasa-menus-wrapper nasa-menus-wrapper-reponsive nasa-loading"
                                                ...
                                                <div class="nav-wrapper main-menu-warpper">
                                                    <ul id="site-navigation"
                                                        ...
                                                        <li
                                                            class="menu-item menu-item-home current-menu-item page_item page-item-3714 current_page_item default-menu root-item nasa_even">
                                                            <a title="Home" href="<?php echo osc_item_post_url_in_category() ; ?>" class="nasa-title-menu">
                                                                <i class="pe-7s-angle-down nasa-open-child"></i><?php _e("Publish your ad for free", 'twitter'); ?>
                                                            </a>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div
                                                ...
                                                <div class="search-wrapper nasa-ajax-search-form-container modern">
                                                    <form role="search" method="get"
                                                        class="nasa-search nasa-ajax-search-form"
