...
<html dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body class="home page-template-default page page-id-3714 theme-elessi-theme nasa-woo-actived nasa-core-actived woocommerce-no-js ehf-template-elessi-theme ehf-stylesheet-elessi-theme-child antialiased nasa-quickview-on nasa-focus-main-image nasa-crazy-load crazy-loading nasa-label-attr-single nasa-image-square elementor-default elementor-kit-7 elementor-page elementor-page-3714">
