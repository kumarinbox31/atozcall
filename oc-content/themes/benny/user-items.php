<?php
    ...
    benny_add_body_class('user user-items');
...
<div class="list-header">
    <?php osc_run_hook('benny_search_ads_listing_top'); ?>
    <h1><?php _e('My listings', 'benny'); ?></h1>
    <?php if(osc_count_items() == 0) { ?>
        <p class="empty" ><?php _e('No listings have been added yet', 'benny'); ?></p>
    <?php } else { ?>
        <div class="actions">
