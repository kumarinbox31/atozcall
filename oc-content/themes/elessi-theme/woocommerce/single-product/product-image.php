...
// $video_title = esc_attr(get_the_title($attach_video_id));
// $data_rel = '';
                            ...
                            <?php if ($video_url) : ?>
                                <div class="item-wrap">
                                    <div class="nasa-item-main-video-wrap nasa-item-main-image-wrap" data-key="<?php echo (int) $_i+1; ?>">
                                        <?php echo do_shortcode('[video src="' . esc_url($video_url) . '" loop="on" preload="auto"]'); ?>
                                        <img class="ns-video-size" src="<?php echo esc_url($image_link); ?>" alt="" />
                                        <canvas class="ns-canvas" style="display: none;"></canvas>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
