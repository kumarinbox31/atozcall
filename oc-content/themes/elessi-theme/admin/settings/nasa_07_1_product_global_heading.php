...
if (!function_exists('elessi_product_global_heading')) {
    function elessi_product_global_heading() {
        ...
        $of_options[] = array(
            "name" => __("Hover Product Effect", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => __("Display product Categories on the Grid", 'elessi-theme'),
            "id" => "loop_categories",
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Display product SKU on the Grid", 'elessi-theme'),
            "id" => "loop_sku",
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Add To Cart in Loop", 'elessi-theme'),
            "id" => "loop_add_to_cart",
            "std" => "1",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            ...
            "options" => array(
                ...
                "popup" => __("Popup Your Order - Not use with Mobile App Simulation", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => __("Quantity Input - Off-Canvas Cart", 'elessi-theme'),
            "id" => "mini_cart_qty",
            "std" => "1",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            "name" => __("Subtotal for Item - Off-Canvas Cart", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => __("Disable ajax Progress Bar Loading", 'elessi-theme'),
