...
if (!function_exists('elessi_product_detail_heading')) {
    function elessi_product_detail_heading() {
        ...
        $of_options[] = array(
            "name" => __("Single Product Options", 'elessi-theme'),
            "std" => "<h4>" . __("Single Product Options", 'elessi-theme') . "</h4>",
            "type" => "info",
            'class' => 'first'
        );
        ...
        $of_options[] = array(
            ...
            'desc' => '<span class="red-color">' . __('Note: The Hover Zoom Image Will be Turned Off!!!', 'elessi-theme') . '</span>'
        );
        ...
        $of_options[] = array(
            "name" => __("Lightbox Image When click", 'elessi-theme'),
        ...
        $of_options[] = array(
            ...
            "std" => "<h4>" . __("Related Products", 'elessi-theme') . "</h4>",
            "type" => "info"
        );
