...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body.nasa-dark .nasa-static-sidebar.style-1 .mini-cart-item .product-name:hover,
            ...
            body .nasa-bot-icons:hover .nasa-svg-shop,
            body .nasa-bot-icons:focus .nasa-svg-shop {
                fill:<?php echo esc_attr($color_primary_darken); ?>;
            }
